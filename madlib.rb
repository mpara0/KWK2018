...
#option B madlib - halloween themed madlib
def option_b
...
noun2 = gets.chomp
puts 'give me an thing'
thing = gets.chomp

#takes user input are generated in this madlib
puts "I can't believe it is already #{holiday}! I can't wait to put on my #{noun1} and visit every #{place} in my neighborhood. This year, I am going with #{person} with #{adj1} #{body_part}! Before I leave, I want to make sure I bring my #{noun2} to carry all my #{thing}. "
end

def mad_libs
  puts "Hello! Welcome to Mad Libs :)
These are supposed to be funny but I honestly don't know how this is gonna go, so lets hope it goes well. Let's begin! Pick option a, b, or c!"
  option = gets.chomp
  if option == "a"
    puts option_a
  elsif option == "b"
